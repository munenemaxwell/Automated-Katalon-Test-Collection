...
//var_product_name='iphone'
WebUI.openBrowser('https://www.masoko.com/')

WebUI.waitForPageLoad(5, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Search_Objects/Page_Shop Online in Kenya - Pay Con/search_product'), var_product_name_neg)
